...
web::json::value PostTestClient_request::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("extraClientConnectResponseData"))] = ModelBase::toJson(m_ExtraClientConnectResponseData);
    }
...
bool PostTestClient_request::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("extraClientConnectResponseData"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("extraClientConnectResponseData")));
        if(!fieldValue.is_null())
        {
...
void PostTestClient_request::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_ExtraClientConnectResponseDataIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("extraClientConnectResponseData")), m_ExtraClientConnectResponseData));
    }
}
...
bool PostTestClient_request::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("extraClientConnectResponseData"))))
    {
        bool refVal_setExtraClientConnectResponseData;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("extraClientConnectResponseData"))), refVal_setExtraClientConnectResponseData );
        setExtraClientConnectResponseData(refVal_setExtraClientConnectResponseData);
    }
    return ok;
}
