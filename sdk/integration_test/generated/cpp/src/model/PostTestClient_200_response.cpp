...
PostTestClient_200_response::PostTestClient_200_response()
{
...
void PostTestClient_200_response::validate()
{
    // TODO: implement validation
}

web::json::value PostTestClient_200_response::toJson() const
{
...
bool PostTestClient_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostTestClient_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostTestClient_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PostTestClient_200_response::getProductId() const
{
    return m_ProductId;
}


void PostTestClient_200_response::setProductId(const utility::string_t& value)
{
    m_ProductId = value;
    m_ProductIdIsSet = true;
}

bool PostTestClient_200_response::productIdIsSet() const
{
    return m_ProductIdIsSet;
}

void PostTestClient_200_response::unsetProductId()
{
    m_ProductIdIsSet = false;
}
utility::string_t PostTestClient_200_response::getDeviceId() const
{
    return m_DeviceId;
}


void PostTestClient_200_response::setDeviceId(const utility::string_t& value)
{
    m_DeviceId = value;
    m_DeviceIdIsSet = true;
}

bool PostTestClient_200_response::deviceIdIsSet() const
{
    return m_DeviceIdIsSet;
}

void PostTestClient_200_response::unsetDeviceId()
{
    m_DeviceIdIsSet = false;
}
utility::string_t PostTestClient_200_response::getEndpointUrl() const
{
    return m_EndpointUrl;
}


void PostTestClient_200_response::setEndpointUrl(const utility::string_t& value)
{
    m_EndpointUrl = value;
    m_EndpointUrlIsSet = true;
}

bool PostTestClient_200_response::endpointUrlIsSet() const
{
    return m_EndpointUrlIsSet;
}

void PostTestClient_200_response::unsetEndpointUrl()
{
    m_EndpointUrlIsSet = false;
}
utility::string_t PostTestClient_200_response::getTestId() const
{
    return m_TestId;
}


void PostTestClient_200_response::setTestId(const utility::string_t& value)
{
    m_TestId = value;
    m_TestIdIsSet = true;
}

bool PostTestClient_200_response::testIdIsSet() const
{
    return m_TestIdIsSet;
}

void PostTestClient_200_response::unsetTestId()
{
    m_TestIdIsSet = false;
}
