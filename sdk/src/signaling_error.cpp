...
{
    switch (code) {
    case SignalingErrorCode::DECODE_ERROR: return "DECODE_ERROR";
    case SignalingErrorCode::VERIFICATION_ERROR: return "VERIFICATION_ERROR";
    ...
    case SignalingErrorCode::NO_MORE_CHANNELS: return "NO_MORE_CHANNELS";
    case SignalingErrorCode::ACCESS_DENIED: return "ACCESS_DENIED";
    case SignalingErrorCode::INTERNAL_ERROR: return "INTERNAL_ERROR";
